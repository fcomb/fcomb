...
private[api] object ImageMethodsFormat {
  implicit val imageItemFormat = jsonFormat(
    ImageItem,
    "Id",
    "ParentId",
    "RepoTags",
    ...
    def read(v: JsValue) = v match {
      case obj: JsObject ⇒
        ImageInspect(
          ...
          repositoryTags =
            obj.getList[String]("RepoTags"),
          repositoryDigests = obj.getList[String]("RepoDigests"),
          parentId =
            obj.getOpt[String]("Parent"),
          comment =
            obj.getOpt[String]("Comment"),
          createdAt =
  ...
  implicit val imageSearchResultFormat = jsonFormat(
    ImageSearchResult,
    "description",
    "is_official",
    "is_automated",
