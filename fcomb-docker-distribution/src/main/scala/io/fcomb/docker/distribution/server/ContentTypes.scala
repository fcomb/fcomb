...
object ContentTypes {
  val `application/vnd.docker.distribution.manifest.v1+json` = ContentType(
      MediaTypes.`application/vnd.docker.distribution.manifest.v1+json`, HttpCharsets.`UTF-8`)
  val `application/vnd.docker.distribution.manifest.v1+prettyjws` = ContentType(
      MediaTypes.`application/vnd.docker.distribution.manifest.v1+prettyjws`, HttpCharsets.`UTF-8`)
  ...
  val `application/vnd.docker.distribution.manifest.v2+json` = ContentType(
      MediaTypes.`application/vnd.docker.distribution.manifest.v2+json`, HttpCharsets.`UTF-8`)
