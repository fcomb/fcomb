...
object MediaTypes {
  val `application/vnd.docker.distribution.manifest.v1+json` = MediaType
    .applicationWithFixedCharset("vnd.docker.distribution.manifest.v1+json", HttpCharsets.`UTF-8`)
  val `application/vnd.docker.distribution.manifest.v1+prettyjws` =
    MediaType.applicationWithFixedCharset("vnd.docker.distribution.manifest.v1+prettyjws",
                                          HttpCharsets.`UTF-8`)
  ...
  val `application/vnd.docker.distribution.manifest.v2+json` = MediaType
    .applicationWithFixedCharset("vnd.docker.distribution.manifest.v2+json", HttpCharsets.`UTF-8`)
